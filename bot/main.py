...
<b>⚠️ Верим в хорошее, но проверяем.</b> Если новый друг просит деньги, пароли или странные коды — это 100% мошенник. Блокируй и доложи боту.

<b>🤐 Не засоряем эфир.</b> Отправлять десять раз «привет» или ссылки на свои каналы — моветон.

<b>📢 Если ты столкнулся с нарушением этих правил — обязательно пожаловайся!</b> Это помогает всем.
