...
async def cmd_rules(message: Message):
    """📄 Правила общения"""
    rules_text = """
📄 <b>ПРАВИЛА ОБЩЕНИЯ В ИНТЕРНЕТЕ И ТЕЛЕГРАМЕ</b>

<b>✅ ОСНОВНЫЕ ПРИНЦИПЫ:</b>
• <b>Вежливость и уважение</b> - Относитесь к людям так, как бы вы хотели, чтобы относились к вам
...
• <b>Честность</b> - Не обманывайте и не выдавайте себя за другого человека

<b>🛑 ЗАПРЕЩЕННОЕ СОДЕРЖАНИЕ:</b>
• 🚫 Не сло­жай режимом ни безопасности и приватности
...
• 🚫 Не распространяйте NSFW контент без согласия
• 🚫 Не пытайтесь манипулировать или шантажировать других

<b>💬 ПРАВИЛА ОБЩЕНИЯ:</b>
• 📝 Пишите понятно и грамотно
• 📝 Избегайте КАПСОВ - это выглядит как крик
• 📝 Будьте краткими и информативными
• 📝 Не спамьте одинаковые сообщения
• 📝 Уважайте время собеседника

<b>❌ НЕ ДЕЛАЙТЕ:</b>
• Не оставляйте оскорбительные комментарии
• Не публикуйте чужие фото без разрешения
• Не распространяйте слухи и ложную информацию
• Не давайте рекламу или ссылки на сомнительные сайты
• Не преследуйте и не беспокойте других пользователей
• Не используйте бот для противоправной деятельности

<b>✨ ЗДОРОВОЕ СООБЩЕСТВО:</b>
• ✅ Поддерживайте позитивную атмосферу
• ✅ Помогайте новичкам разобраться
• ✅ Сообщайте о нарушениях модераторам
• ✅ Уважайте разные мнения и культуры
• ✅ Создавайте интересные диалоги

<b>⚠️ ПОСЛЕДСТВИЯ НАРУШЕНИЙ:</b>
• Первое предупреждение - устное замечание
• Второе нарушение - временный мут
• Третье нарушение - блокировка аккаунта
• Серьёзные нарушения - немедленная блокировка

📞 <b>КОНТАКТЫ:</b> Если у вас есть вопросы или жалобы, обратитесь к @Dontonu

<b>Спасибо за понимание! Давайте вместе создавать дружелюбное сообщество!</b>
"""
...
<b>📋 ОСНОВНЫЕ КОМАНДЫ:</b>
/search - поиск собеседника
/next - закончить текущий диалог и сразу же искать нового
/stop - закончить разговор с собеседником
/interests - выбрать интересы поиска
/pay - поиск по полу, оформление и управление премиумом
/link - отправить собеседнику ссылку на вас в Телеграме
...
async def main():
    ...
    try:
        ...
        logger.info("📱 BOT STARTED - Премиум, правила, помощь и VIP удален!")
